import { HomeIcon, MoonIcon, PersonStandingIcon, SunIcon, UserIcon, UtensilsIcon } from "lucide-react"
...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        { path: '/activity', label: 'Activity', icon: UserIcon }, // ✅ fixed typo
    ]
    ...
    return (
        <nav className="hidden lg:flex flex-col w-64 bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800 p-6 transition-colors duration-200">
            ...
            <div className="flex items-center gap-3 mb-8">
                <div className="size-10 rounded-xl bg-emerald-500 flex items-center justify-center"> {/* ✅ emerald fixed */}
