    ...
    <div className="page-container">
      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-card-grid">
          {/* active minutes wala card */}
          <Card>
            <div className="flex ietms-center gap-3 mb-3">
              <div>
            ...
            <p className="text-sm text-slate-400">activities logger</p>
            </Card>
        ...
        {/* body metrics wala card */}
        {user && user.weight && (
          <Card>
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 rounded-xl bg-indigot/100 flex items-center justify-center">
